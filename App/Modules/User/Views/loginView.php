<div class="container addMarginBot">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
                    ...
                    <form method="post" action="" role="form">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="Nom d'utilisateur" name="username" type="text" required="required" autofocus>
                            </div>
                            <div class="form-group">
            ...
            <p><em>Pas encore de compte ? <a href="register">Inscrivez-vous</a></em></p>
        </div>
    </div>
</div>